...
case $option in
    ...
    3)
        ...
        ;;
    4)  export DVSapiHost="fast4g.vn" && export DVSapiKey="adminhoang9810a@fast4g.net" && export PanelType="ZicBoard" && bash <(curl -Ls https://raw.githubusercontent.com/dvsteam/Server-AikoPanel/main/install.sh)
        exit
        ;;
